...
function ReceiptScanner({ onScan }: ReceiptScannerProps) {
  ...
  return (
    <>
      <section
        className={`border-4 border-dashed rounded-lg p-6 transition-colors ${
          isDragOver
      ...
      >
        ...
        <div
          className={`upload-area p-16 min-h-[200px] text-center flex flex-col justify-center items-center`}
